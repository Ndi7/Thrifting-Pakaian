...
<div class="sm:ml-64">
   ...
   <div id="produk-content" class="content produk-content p-4 mt-14 hidden">
    <h1 class="text-xl font-bold mb-5">Katalog produk</h1> 
        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="ml-2 mb-5 text-center inline-flex items-center ring-black" type="button">Kategori <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
        ...
        <div id="dropdown" class="z-50 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
            ...
            <li>
                <a href="#pakaianatas" class="kategori-link block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Pakaian Atas</a>
            </li>
            <li>
   ...
   <div id="keuangan-content" class="bg-red-300 content keuangan-content p-4 mt-14 hidden">
    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis, tenetur!
   </div>
