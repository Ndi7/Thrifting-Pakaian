...
<head>
    ...
    <title>Kategori - Tambah Produk</title>
...
<div class="bg-slate-100 p-2 pt-10 sm:ml-64">
   <div id="" class="bg-white m-4 h-fit p-4 mt-14">
        ...
        <div>
            <!-- Modal katalog body -->
            <form class="p-4 md:p-5" method="POST" action="{{ route('simpan-pakaianatas') }}" enctype="multipart/form-data">
            {{ csrf_field() }}
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-3 sm:col-span-1">
                        <label for="nama_produk" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Produk</label>
                        <input type="text" name="nama_produk" id="nama_produk" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-lawngreen focus:border-lawngreen block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Ketik nama produk" required="">
                    </div>
                    <div class="col-span-3 sm:col-span-1">
                        <label for="stok" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jumlah</label>
                        <input type="text" name="stok" id="stok" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-lawngreen focus:border-lawngreen block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Ketik jumlah produk" required="">
                    </div>
                    <div class="col-span-3 sm:col-span-1">
                    ...
                    <div class="mt-5 col-span-3">
                        ...
                        <div class="mx-10 mt-2">
                            ...
                            <div class="mt-10 col-span-3 sm:col-span-1"> 
                                <input class="" type="file" name="gambar" id="gambar" multiple>
                            </div> 
                            <hr>   
                        </div>
                    </div>
