...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans antialiased">
        <div class="relative min-h-screen md:flex" x-data="{ open: false}">
            <!-- sidebsr -->
            <aside :class="{ '-translate-x-full': !open}" class="z-10 bg-neutral-50 text-lime-900 w-64 px-2 py-4 absolute inset-y-0 left-0 md:relative
                ...
                <div class="flex items-center justify-between mb-5 px-2">
                    <div class="flex items-center space-x-2">
                        <a href="{{ route('dashboard') }}">
                            <x-application-logo class="block h-10 w-auto fill-current text-lime-900" />
                        </a>
                ...
                <button type="button" @click="open = !open" class="md:hidden inline-flex p-2 items-center justify-center 
                    rounded-md text-lime-900 hover:bg-lime-200 focus:outline-none">
                ...
                <nav>
                    ...
                    <x-side-nav-link href="{{ route('product') }}" :active="request()->routeIs('product')">
                        produk
                    </x-side-nav-link>
            ...
            <main class="flex-1 bg-gray-100 h-screen">
                ...
                <!-- Nvbar -->
                <nav class="bg-neutral-50 shadow-lg">
                    <div class="mx-auto px-2 sm:px-6 lg:px-8">
                        <div class="relative flex items-center justify-between md:justify-end h-16">
                            <div class="absolute inset-y-0 left-0 flex items-center md:hidden">
                                ...
                                p-2 rounded-md text-lime-900 hover:bg-lime-200 focus:outline-none" >
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center">
                                <x-dropdown align="right" width="48">
                                    <x-slot name="trigger">
                                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-lime-900 dark:text-gray-400 bg-white dark:bg-gray-800 hover:bg-lime-200 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
